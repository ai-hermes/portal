...
const docTemplate = `{
    ...
    "paths": {
        ...
        "/api/v1/auth/password/reset/phone": {
            "post": {
                ...
                "parameters": [
                    {
                        "description": "Reset password by phone payload",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/api.resetPasswordByPhoneRequest"
                        }
                    }
                ],
                "responses": {
    ...
    "definitions": {
        ...
        "api.resetPasswordByPhoneRequest": {
            "type": "object",
            "properties": {
                "code": {
                    "type": "string"
